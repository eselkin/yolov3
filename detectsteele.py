...
def detect(
    ...
    # Set Dataloader
    dataloader = LoadVideo(video, img_size=img_size)

    # Get classes and colors
    classes = load_classes(parse_data_cfg('cfg/steele.data')['names'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video', type=str, default='/ml_data/Analog_20180105_1246_mpeg2video.mpg', help='path to video file')
